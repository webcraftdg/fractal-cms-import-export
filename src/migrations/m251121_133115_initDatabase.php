    ...
    public function up()
    {
        ...
        $this->createTable(
            ...
            [
                ...
                'rowTransformer'=> $this->string(15)->defaultValue(null),
        ...
        $this->createTable(
            ...
            [
                ...
                'format'=> $this->string(50)->defaultValue(null),
        ...
        $this->createTable(
            ...
            [
                ...
                'errors' => $this->binary()->defaultValue(null),
                'errorFilePath' => $this->string()->defaultValue(null),
                'dateCreate'=> $this->datetime()->defaultValue(null),
                'dateUpdate'=> $this->datetime()->defaultValue(null),
            ]
        );
