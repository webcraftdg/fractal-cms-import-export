 ...
 * @version XXX
 * @package fractalCms\importExport\pipeline\formatters
 */
namespace fractalCms\importExport\pipeline\formatters;

use fractalCms\importExport\models\ImportConfig;
use Exception;
use fractalCms\importExport\pipeline\interfaces\RecordFormatter as RecordFormatterInterface;
use Yii;

class Record implements RecordFormatterInterface 
{
